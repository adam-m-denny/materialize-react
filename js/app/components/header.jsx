      ...
      return (
        <nav className="white">
          <div className="nav-wrapper white black-text container">
            <a href="#!" className="brand-logo black-text"><img src="http://localhost/wordpress/wp-content/themes/materialize-react/images/OWPLogo.png" /></a>
            <a href="#" data-activates="mobile-demo" className="button-collapse black-text"><i className="material-icons">menu</i></a>
            <ul className="right hide-on-med-and-down">
              {navLinks}
              <li className="social"><a href="#facebook"><i className="fa fa-facebook" aria-hidden="true"></i></a></li>
              <li className="social"><a href="#instagram"><i className="fa fa-instagram" aria-hidden="true"></i></a></li>
            </ul>
